...
output "redhat_openshift_clusters_api_server_profile" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.api_server_profile) if v.api_server_profile != null && length(v.api_server_profile) > 0 }
}
output "redhat_openshift_clusters_cluster_profile" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.cluster_profile) if v.cluster_profile != null && length(v.cluster_profile) > 0 }
  sensitive   = true
}
...
output "redhat_openshift_clusters_ingress_profile" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.ingress_profile) if v.ingress_profile != null && length(v.ingress_profile) > 0 }
}
...
output "redhat_openshift_clusters_main_profile" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.main_profile) if v.main_profile != null && length(v.main_profile) > 0 }
}
...
output "redhat_openshift_clusters_network_profile" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.network_profile) if v.network_profile != null && length(v.network_profile) > 0 }
}
...
output "redhat_openshift_clusters_service_principal" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.service_principal) if v.service_principal != null && length(v.service_principal) > 0 }
  sensitive   = true
}
...
output "redhat_openshift_clusters_worker_profile" {
  ...
  value       = { for k, v in azurerm_redhat_openshift_cluster.redhat_openshift_clusters : k => one(v.worker_profile) if v.worker_profile != null && length(v.worker_profile) > 0 }
}
